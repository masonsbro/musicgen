...
urlpatterns = patterns('',
	...
	url(r'^update/(?P<id>[0-9]+)/(?P<page>[0-9]+)/$', views.updateFiles),
	...
	url(r'^del/(?P<id>[0-9]+)/(?P<page>[0-9]+)/$', views.delete),
	url(r'^mut/(?P<id>[0-9]+)/(?P<page>[0-9]+)/$', views.mutate),
	url(r'^delU/(?P<id>[0-9]+)/(?P<page>[0-9]+)/$', views.deleteUser),
	url(r'^delR/(?P<id>[0-9]+)/(?P<page>[0-9]+)/$', views.deleteRating),
	url(r'^$', views.index),
)