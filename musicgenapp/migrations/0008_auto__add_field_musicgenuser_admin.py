...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MusicGenUser.admin'
        db.add_column(u'musicgenapp_musicgenuser', 'admin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MusicGenUser.admin'
        db.delete_column(u'musicgenapp_musicgenuser', 'admin')
