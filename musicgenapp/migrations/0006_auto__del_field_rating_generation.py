...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Rating.generation'
        db.delete_column(u'musicgenapp_rating', 'generation')


    def backwards(self, orm):
        # Adding field 'Rating.generation'
        db.add_column(u'musicgenapp_rating', 'generation',
